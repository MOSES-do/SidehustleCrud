...
<div style="position:fixed">
            ...
            <form action="logout.php" method ="POST">
             ...
             <input type = "submit"  value="Logout" style="margin-left:40em; position:absolute; top:0em;" name="logout" class="btn btn-success logout">
        ...
        <?php 
            ...
            echo "<span class='name'  style='margin:0px; font-weight:bold; position:absolute; width:8em; margin-left:50em; top:5px;'>" .'Hello, ' . $_SESSION["Username"] . "</span>";
